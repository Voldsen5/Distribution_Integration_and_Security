...
public class testsql {
        ...
        // TODO Auto-generated method stub
            try {
                ...
                ResultSet res = stmt.executeQuery("select * from konto with(UPDLOCK) where kontonr =" + fraKonto);
                if (!res.next()){
                ...
                ResultSet res2 = stmt.executeQuery("select * from konto with(UPDLOCK) where kontonr =" + tilKonto);
                if (!res2.next()){
                    throw new RuntimeException("Konto-nr findes ikke");
                }
